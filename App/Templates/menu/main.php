...
<button onclick="document.location = 'multi_delete.php'" type="button">МУЛТИ триене</button>
<button onclick="document.location = 'index.php'" type="button">История на записите</button>
<button onclick="document.location = 'login.php'" type="button">вход - потребителски</button>
